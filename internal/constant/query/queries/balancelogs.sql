...
INSERT INTO balance_logs (user_id,component,change_amount,operational_group_id,operational_type_id,description,TIMESTAMP,balance_after_update,transaction_id,status)
