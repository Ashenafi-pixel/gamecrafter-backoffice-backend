...
func (s *LevelProgressionService) ProcessSingleLevelProgression(ctx context.Context, userID uuid.UUID) (*dto.LevelProgressionResult, error) {
	...
	s.logger.Info("Single level progression completed",
		zap.String("user_id", userID.String()),
		zap.Int("new_level", userLevel.CurrentLevel),
		zap.String("level_progress", userLevel.LevelProgress.String()))
